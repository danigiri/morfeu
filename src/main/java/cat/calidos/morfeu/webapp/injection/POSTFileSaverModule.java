...
@Produces @IntoMap @Named("PreFilters") @IntKey(1000)
public static BiFunction<HttpServletRequest, HttpServletResponse, Boolean> postSaver(@Named("POSTFileSaverModule-POSTUri") Producer<String> uri) {
...
public static String uri(HttpServletRequest request) {
	...
	prefix = (String) ((Properties) ctxt.getAttribute(GenericHttpServlet.__CONFIG))
			.get("__RESOURCES_PREFIX");
