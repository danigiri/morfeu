...
public void validate() throws ValidationException, FetchingException {
	...
	if (validator == null) {
		throw new ValidationException("Document does not have a validation mechanism",
...
public String toString() {
	return "{" + this.name + ", [" + this.kind + "], uri:" + this.uri + ", prefix:" + prefix
			+ ", model:" + this.modelURI + ", doc:" + this.contentURI + "}";
}
