...
/**
 * This is at the moment only used for testing, as SchemaParserModule is included directly as a
 * dependency (Eclipse gets confused about this one, so moving it from the test location to here)
 * 
