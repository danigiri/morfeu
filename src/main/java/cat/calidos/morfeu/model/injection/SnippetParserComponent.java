...
/**
 * Component to get cell data from a snippet (can be optionally filtered), needs the cellmodel
 * (within th emodel the model hierarchy). Very similar to the regular content parser component
 * 
