...
/**
 * Module to get the document cell content TODO: ensure all this is actually asynchronous
 * 
...
public static Document produceDocument(	@Named("NormalisedDocument") Document doc,
	...
	try {
		...
		throw new ExecutionException("Problem with model of document '" + doc.getName()
				+ "' with model: '" + doc.getModelURI() + "', (" + e.getMessage() + ")", e);
	}
...
public static InputStream fetchDocumentJSON(URI uri,
...
public static Document parseDocument(	URI uri,
										@Named("JSONDocumentStream") InputStream docStream,
										ObjectMapper mapper)
...
// this is a model uri that is absolute and fetchable, guaranteed to be reachable from any runtime
// context
@Produces @Named("FetchableModelURI")
public static URI fetchableModelURI(@Named("PrefixURI") URI prefix,
...
// this is a content uri that is absolute and fetchable, guaranteed to be reachable from any runtime
// context
@Produces @Named("FetchableContentURI")
public static URI fetchableContentURI(	@Named("PrefixURI") URI prefix,
										@Named("ParsedDocument") Document doc)
		throws ParsingException {
