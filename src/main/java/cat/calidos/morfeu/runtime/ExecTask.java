...
public void startRedirectingOutput() {
	...
	// we are using the indirection as the executor.redirect* methods are non-reentrant, namely, if
	// they are called
...
private InputStream stdinStream(String stdin) {
	...
	// this is setup as a private method as we want to set it outside the exec task injection
	// creation
