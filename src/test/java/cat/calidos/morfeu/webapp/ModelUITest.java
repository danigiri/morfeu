...
public void modelDisappearsOnClickingOtherCatalogue() {
	...
	UIModel model = catalogue.clickOnDocumentNamed("Document 1").model().shouldAppear();
...
public void testCellModels() {
	...
	// selenium finds the expand button, but it complains it's not clickable, we disable this for
	// now as it's not core
	// functionality
